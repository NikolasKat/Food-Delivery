...
//   function hideAllContentForTabs() {
//     // Табы
...
//   function showAllContentForTabs(i = 0) {
//     // Табы
...
//     return data;
// }).then(data => console.log("My final data", data));
...
// sleep(500).then(() => console.log("After 500"));
// sleep(1000).then(() => console.log("After 1000"));
...
//             data.ploshyad = data.width * data.height;
//             resolve(data);
//         }, 1500);
